...
| As a user, I want to register an account with the restaurant in order to book a table.  | ![screenshot](https://res.cloudinary.com/dugcwv1mf/image/upload/v1698495116/Project%204/Screenshot_2023-10-28_at_1.11.37_PM_h9j47t.png) | Works as expected |
| As a user, I want to log-into my account with the restaurant in order to CRUD bookings and deliveries.  | ![screenshot](https://res.cloudinary.com/dugcwv1mf/image/upload/v1698495179/Project%204/Screenshot_2023-10-28_at_1.12.41_PM_a2poq3.png) | Works as expected |
...
| As a user, I want to be able to edit and update my food delivery details.  | ![screenshot](https://res.cloudinary.com/dugcwv1mf/image/upload/v1698497025/Project%204/Screenshot_2023-10-28_at_1.43.26_PM_ehx2kh.png) | Works as expected |
